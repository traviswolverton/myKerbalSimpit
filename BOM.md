...
- **6mm push button** — two plausible matches depending on how it's actually mounted: a standard 6×6mm PCB tactile switch, e.g. [100-pack 6×6mm tactile buttons](https://www.amazon.com/6x6x7mm-Momentary-Tactile-Button-Through/dp/B008DS1DPM) (pick a leg height matching your mounting depth: 5mm/6.5mm/7mm/9.5mm variants), or if it's actually front-panel mounted like the buttons visible in the WIP photo, a small round panel-mount momentary button, e.g. [SparkFun panel-mount momentary button, black](https://www.sparkfun.com/momentary-button-panel-mount-black.html). Confirm which style against the panel STL before ordering 20 of them.
