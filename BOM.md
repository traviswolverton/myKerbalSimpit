...
- **12mm switch** — 12mm momentary metal panel-mount pushbutton, e.g. [12mm stainless SPST momentary switch](https://www.amazon.com/Momentary-Button-Switch-Waterproof-Mounting/dp/B07411Z79K). The WIP build photo shows several banks of round, metal-bezel momentary buttons (groups of 8 and 10) that look closer to this 12mm panel-mount style than to a tiny PCB tactile switch — worth double-checking against the panel STLs which positions actually call for the 6mm tactile switch vs. this 12mm one before buying in bulk.
...
- **6mm push button** — geometry check (below) confirms these are front-panel mounted with a **7mm round cutout**, not a bare 6×6mm PCB tactile switch — matches the round metal-bezel buttons visible in the WIP photo. Sunrom sells this exact size directly: [7mm momentary push button, black](https://www.sunrom.com/p/black-push-button-switch-7mm-momentary) (also in [red](https://www.sunrom.com/p/red-push-button-switch-7mm-momentary) and [green](https://www.sunrom.com/p/green-push-button-switch-7mm-momentary)). If you'd rather buy on Amazon, the [SparkFun panel-mount momentary button](https://www.sparkfun.com/momentary-button-panel-mount-black.html) specs a 6.75mm hole — close enough to fit a 7mm cutout with a little clearance, but not an exact match.
- **19mm LED push buttons (Green/White/Blue/Yellow + regular Red, ×9–10)** — 19mm illuminated momentary pushbutton, e.g. [Quentacy 19mm 12V LED momentary pushbutton](https://www.amazon.com/Quentacy-Momentary-Waterproof-Stainless-Illuminated/dp/B075Q9QSX4) or the [DAIER 19mm series](https://www.daierswitches.com/products/19mm-lighted-latching-push-button-switch-with-pre-wired) — buy the **momentary** variant, not latching, and confirm LED voltage (commonly 12V in this product family, though not stated on the drawing). Geometry check (below) confirms these genuinely need a 19mm hole.
- **19mm LED push button — Red "Large" (Abort/Stage, ×2)** — geometry shows these need a ~20mm hole, not 19mm. Closer match: [Aexit 20mm red LED momentary stainless pushbutton](https://www.amazon.com/Aexit-Momentary-Stainless-Pushbutton-Terminals/dp/B07KVYBBBG). Buy these separately from the other 19mm colors rather than assuming one size fits all.
